  ...
  return (
    <div className="bg-gray-400 rounded-xl pb-3">
      ...
      <div className="flex gap-3 px-2">
        <button onClick={onDislike} className="flex-1 bg-purple-500 rounded-xl px-5 py-2 text-lg cursor-pointer hover:scale-105 duration-300 ease-in-out">Not for me</button>
        <button onClick={onLike} className="flex-1 bg-purple-500 rounded-xl px-5 py-2 text-lg cursor-pointer hover:scale-105 duration-300 ease-in-out">Love it!</button>
      </div>
    </div>  
  );
}
